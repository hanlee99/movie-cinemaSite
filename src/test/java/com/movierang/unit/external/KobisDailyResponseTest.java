...
/**
 * KobisDailyResponse 단위 테스트
 * - KOBIS 외부 API JSON 파싱 테스트
 */
@DisplayName("KobisDailyResponse 단위 테스트")
class KobisDailyResponseTest {
    private final ObjectMapper objectMapper = new ObjectMapper();

    @Test
    @DisplayName("KOBIS API 응답 파싱 성공")
    void KOBIS_API_응답_파싱_테스트() throws Exception {
        // given - 실제 KOBIS API 응답
        String json = """
            {
                "boxOfficeResult": {
